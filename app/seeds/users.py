...
def seed_users():
    ...
    ron = User(first_name='Ronald', last_name='Weasley', username='Ron', email='rweasley@hogwarts.edu', password='password', house='Gryffindor', year=3, bio='Chudley Cannons 4 lyfe', pic='https://res.cloudinary.com/dsebdtcp0/image/upload/v1645028989/magicbook/Ron_z5tjl4.jpg')
