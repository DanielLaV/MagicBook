...
def seed_users():
    ...
    hermione = User(first_name='Hermione', last_name='Granger', username='Hermione', email='hermione@hogwarts.edu', password='password', house='Gryffindor', year=3, bio="Books are amazing. Why wasn't I put in Ravenclaw?", pic='https://res.cloudinary.com/dsebdtcp0/image/upload/v1645028987/magicbook/Hermione_zmegde.jpg')
    ron = User(first_name='Ronald', last_name='Weasley', username='Ron', email='ron@hogwarts.edu', password='password', house='Gryffindor', year=3, bio='Chudley Cannons 4 lyfe', pic='https://res.cloudinary.com/dsebdtcp0/image/upload/v1645028989/magicbook/Ron_z5tjl4.jpg')
    ...
    neville = User(first_name='Neville', last_name='Longbottom', username='Neville', email='neville@hogwarts.edu', password='password', house='Gryffindor', year=3, bio='You think Harry has it bad? Check me out', pic='https://res.cloudinary.com/dsebdtcp0/image/upload/v1645028990/magicbook/Neville_h9wis7.jpg')
    ...
    draco = User(first_name='Draco', last_name='Malfoy', username='Draco', email='draco@hogwarts.edu', password='password', house='Slytherin', year=3, bio="I will be the greatest Malfoy yet", pic='https://res.cloudinary.com/dsebdtcp0/image/upload/v1645028986/magicbook/draco_rekbv4.jpg')
    ...
    goyle = User(first_name='Gregory', last_name='Goyle', username='Goyle', email='gregory@hogwarts.edu', password='password', house='Slytherin', year=3, bio='Yous best not hurt da boss', pic='https://res.cloudinary.com/dsebdtcp0/image/upload/v1645028987/magicbook/goyle_ht2eo0.jpg')
    ...
    pansy = User(first_name='Pansy', last_name='Parkinson', username='PansyP', email='pansy@hogwarts.edu', password='password', house='Slytherin', year=3, bio="You're ugly", pic='https://res.cloudinary.com/dsebdtcp0/image/upload/v1645030050/magicbook/dafault-profile_mlbiot.jpg')
    ...
    tracey = User(first_name='Tracey', last_name='Davis', username='TraceyD', email='tracey@hogwarts.edu', password='password', house='Slytherin', year=3, bio="I feel like no one sees me", pic='https://res.cloudinary.com/dsebdtcp0/image/upload/v1645028989/magicbook/tracey_eadxsf.jpg')
    ...
    padma = User(first_name='Padma', last_name='Patil', username='BetterPatil', email='padma@hogwarts.edu', password='password', house='Ravenclaw', year=3, bio="Nothing comes between me and my twin sister.", pic='https://res.cloudinary.com/dsebdtcp0/image/upload/v1645028988/magicbook/patil-twins_ytfw8a.jpg')
